export const secretRules = [
	{
		...
		regex: /\bA3-[A-Z0-9]{6}-(?:(?:[A-Z0-9]{11})|(?:[A-Z0-9]{6}-[A-Z0-9]{5}))-[A-Z0-9]{5}-[A-Z0-9]{5}-[A-Z0-9]{5}\b/g,
		entropy: 3.8,
		group: 0
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:adafruit)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-z0-9_-]{32})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 1
	},
	{
		id: "adobe-client-id",
		...
		regex: /[\w.-]{0,50}?(?:adobe)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-f0-9]{32})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		entropy: 2,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:airtable)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-z0-9]{17})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 1
	},
	{
		id: "algolia-api-key",
		...
		regex: /[\w.-]{0,50}?(?:algolia)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-z0-9]{32})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:alibaba)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-z0-9]{30})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		entropy: 2,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:asana)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([0-9]{16})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 1
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:asana)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-z0-9]{32})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 1
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:atlassian|confluence|jira)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-z0-9]{20}[a-f0-9]{4})(?:[\x60'"\s;]|[\n\r]|$)|(\bATATT3[A-Za-z0-9_\-=]{186}\b)/gi,
		entropy: 3.5,
		group: 0
	},
	{
		...
		regex: /\b((?:sc|ext|scauth|authress)_[a-zA-Z0-9]{5,30}\.[a-z0-9]{4,6}\.acc[_-][a-z0-9-]{10,32}\.[a-z0-9+\/_=-]{30,120})\b/g,
		entropy: 2,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:beamer)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}(b_[a-z0-9=_\-]{44})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 1
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:bitbucket)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-z0-9]{32})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 1
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:bitbucket)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-z0-9=_\-]{64})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 1
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:meraki)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([0-9a-f]{40})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		entropy: 3,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:dropbox)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}(sl\.[a-z0-9\-=_]{135})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 1
	},
	{
		id: "duffel-api-token",
	...
	},
	{
		...
		regex: /\b(fo1_[\w-]{43}|fm1[ar]_[a-zA-Z0-9+\/]{100,}={0,3}|fm2_[a-zA-Z0-9+\/]{100,}={0,3})\b/g,
		entropy: 4,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:access|auth|api|credential|creds|passw(?:or)?d|secret|token)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([\w.=-]{10,150}|[a-z0-9][a-z0-9+\/]{11,}={0,3})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		entropy: 4.3,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:okta)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}(00[\w=\-]{40})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		entropy: 4,
		group: 1
	},
	{
		...
		regex: /\b(sk-(?:proj|svcacct|admin)-(?:[A-Za-z0-9_-]{74}|[A-Za-z0-9_-]{58})T3BlbkFJ(?:[A-Za-z0-9_-]{74}|[A-Za-z0-9_-]{58})|sk-[a-zA-Z0-9]{20}T3BlbkFJ[a-zA-Z0-9]{20})\b/g,
		entropy: 3,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:sentry)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}([a-f0-9]{64})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		entropy: 3,
		group: 1
	},
	{
		...
		regex: /\bsntrys_eyJpYXQiO[a-zA-Z0-9+\/]{10,200}(?:LCJyZWdpb25fdXJs|InJlZ2lvbl91cmwi|cmVnaW9uX3VybCI6)[a-zA-Z0-9+\/]{10,200}={0,2}_[a-zA-Z0-9+\/]{43}(?:[^a-zA-Z0-9+\/]|$)/g,
		entropy: 4.5,
		group: 0
	},
	{
	...
	},
	{
		...
		regex: /https?:\/\/([a-f0-9]{8}:[a-f0-9]{8})@(?:gems.contribsys.com|enterprise.contribsys.com)(?:[\/|#|\?|:]|$)/gi,
		group: 1
	},
	{
		id: "slack-app-token",
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:sonar[_.-]?(login|token))(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}((?:squ_|sqp_|sqa_)?[a-z0-9=_\-]{40})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		group: 2
	},
	{
		id: "sourcegraph-access-token",
		description: "Sourcegraph is a code search and navigation engine.",
		regex: /\b(sgp_(?:[a-fA-F0-9]{16}|local)_[a-fA-F0-9]{40}|sgp_[a-fA-F0-9]{40}|[a-fA-F0-9]{40})\b/gi,
		entropy: 3,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /[\w.-]{0,50}?(?:sumo)(?:[ \t\w.-]{0,20})[\s'"]{0,3}(?:=|>|:{1,3}=|\|\||:|=>|\?=|,)[\x60'"\s=]{0,5}(su[a-zA-Z0-9]{12})(?:[\x60'"\s;]|[\n\r]|$)/gi,
		entropy: 3,
		group: 1
	},
	{
	...
	},
	{
		...
		regex: /\b(?:azure|az)[\-_]?(?:key|secret|token)[\-_]?(?:id|key|value)?["'\s:=]+([a-z0-9]{20,})/gi,
		group: 1
	},
	{
		id: "azure-client-id",
		...
		regex: /\b(?:AZURE_CLIENT_ID|azureClientId|clientId)["'\s:=]+([0-9a-fA-F]{8}-(?:[0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12})\b/gi,
		group: 1
	},
	{
		id: "azure-client-secret",
		description: "Azure Client Secret",
		regex: /(?:AZURE_CLIENT_SECRET|azureClientSecret|clientSecret)["'\s:=]+([a-zA-Z0-9._\-]{20,})/gi,
		group: 1
	},
	{
		id: "azure-tenant-id",
		description: "Azure Tenant ID",
		regex: /(?:AZURE_TENANT_ID|azureTenantId|tenantId)["'\s:=]+([0-9a-fA-F]{8}-(?:[0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12})/gi,
		group: 1
	},
	{
		id: "rsa-private-key",
	...
	},
	{
		...
		regex: /\bAWS4-HMAC-SHA256\s+Credential=[^,\s]+,\s*SignedHeaders=[^,\s]+,\s*Signature=([a-f0-9]{64})/g,
		group: 1
	},
	{
